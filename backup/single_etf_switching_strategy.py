...
<path>3xETF-app-1w/single_etf_switching_strategy.py</path>
<diff>------- SEARCH
            # Moving averages
            symbol_data['sma_10d'] = symbol_data['close'].rolling(10).mean().fillna(method='ffill')
            symbol_data['sma_20d'] = symbol_data['close'].rolling(20).mean().fillna(method='ffill')
=======
            # Moving averages
